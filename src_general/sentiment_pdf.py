...
f_recip_weighted_edges_in = "sentiment/recip_mention_graph_weights.dat"
...
def scatterplot_edges_sent_hist2d_diff(edges_sent_dir, edges_sent_weighted_dir, edges_sent_rec, edges_sent_weighted_rec):
	...
	fig_name_diff = "diff_dir_rec_th10.png"
	...
	fig_name_diff = "diff_dir_rec_weighted_th10.png"
...
def main_scatter_diff():
	os.chdir(IN_DIR)
	f = open(f_weighted_edges_in, 'r')
	edges_sent_dir, edges_sent_weighted_dir = read_in_edges_sent(f, 10)
 

	f = open(f_recip_weighted_edges_in, 'r')
	edges_sent_rec, edges_sent_weighted_rec = read_in_edges_sent(f, 10)
