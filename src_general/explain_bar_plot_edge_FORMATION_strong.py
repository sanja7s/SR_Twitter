...
plt1 = plot_bars_FORMATION_all_TOT(formationDeletionMeans, formationDeletionStd)
...
plt1 = plot_bars_FORMATION_all_REL(formationDeletionMeans, formationDeletionStd)
...
plt2 = plot_bars_FORMATION_persisting_REL(formationNodeletionMeans, formationNodeletionStd)
