...
spec_users = "most_talkative/most_mentionied_users.dat"
...
def read_in_user_list(sizeN=300):
...
def read_save_taxonomy(users="ALL", user_list=None, WRITE=False,TOP_N = 20):
    ...
    with codecs.open(f_in,'r', encoding='utf8') as input_file:
        ...
        if WRITE:
            f_out_name = "most_talkative/taxon_talkative_users.json"
...
def main():
    ...
    sizeN = 300
    top_talkative = read_in_user_list(sizeN)
    print len(top_talkative), "top talkative users found"

    read_save_taxonomy("talkative", top_talkative, WRITE=True)
